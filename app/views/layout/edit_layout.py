...
from views.layouts.form_layout import get_layout_by_name, display_attribute_form, display_attribute_table, display_delete_attributes, delete_selected_attributes, save_layout
...
def edit_layout():
    ...
    # Modificação aqui: Verificar se existem atributos diferentes do layout padrão
